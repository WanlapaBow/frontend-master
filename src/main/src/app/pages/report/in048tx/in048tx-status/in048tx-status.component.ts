...
@Component({
  selector: 'ngx-in048tx-status',
  templateUrl: './in048tx-status.component.html',
  styleUrls: ['./in048tx-status.component.scss'],
})
export class In048txStatusComponent implements ICellRendererAngularComp {
  public params: any;
  statusList: any = {
    success: {
      title: 'success',
