...
import {ReceiptReportService} from './receipt-report.service';
...
export class ReceiptReportComponent implements OnInit, AfterViewInit {
  ...
  constructor(public commonService: CommonService,
              public service: ReceiptReportService,
  ...
  exportReport() {
    if (this.form.value.statementNumber === '' && this.form.value.siteNumber === '') {
      return alert('กรุณาเลือก statement หรือ customer');
    }
    this.isLoading = true;
