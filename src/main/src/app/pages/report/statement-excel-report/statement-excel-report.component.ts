...
import { StatementExcelReportService } from './statement-excel-report.service';

@Component({
  selector: 'ngx-statement-excel-report',
  templateUrl: './statement-excel-report.component.html',
  styleUrls: ['./statement-excel-report.component.scss'],
})
export class StatementExcelReportComponent implements OnInit, AfterViewInit {
  ...
  constructor(public commonService: CommonService,
              public service: StatementExcelReportService,
  ...
  methodFromParent(cell) {
    const params = new HttpParams()
      .set('requestId', cell)
      .set('reportName', 'StatementExcelReport');
    this.service.getDownloadXlsx(params);
  }


  clearData() {
    this.onClearStatement();
    this.form.reset();
    this.customerClassInvalid = false;
  }
}
