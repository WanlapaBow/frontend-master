...
@Component({
  selector: 'ngx-in081n2tx-status',
  templateUrl: './in081n2tx-status.component.html',
  styleUrls: ['./in081n2tx-status.component.scss'],
})
export class In081n2txStatusComponent implements ICellRendererAngularComp {
