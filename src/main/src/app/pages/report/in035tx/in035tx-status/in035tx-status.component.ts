...
@Component({
  selector: 'ngx-in035tx-status',
  templateUrl: './in035tx-status.component.html',
  styleUrls: ['./in035tx-status.component.scss'],
})
export class In035txStatusComponent implements ICellRendererAngularComp {
  public params: any;
  statusList: any = {
    success: {
      title: 'success',
