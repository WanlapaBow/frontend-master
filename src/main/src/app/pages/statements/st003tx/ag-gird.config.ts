...
import { St003txStatementCheckBoxComponent } from './st003tx-statement-check-box/st003tx-statement-check-box.component';
...
const setting = [
  {
    ...
    field: 'isCheck',
    filter: false,
    cellRendererFramework: St003txStatementCheckBoxComponent,
