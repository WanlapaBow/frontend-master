...
import { St002txCheckboxWhtComponent } from './st002tx-checkbox-wht/st002tx-checkbox-wht.component';
import { St002txCheckboxComponent } from './st002tx-checkbox/st002tx-checkbox.component';
...
const settingLine = [
  {
    ...
    field: 'isCheck',
    filter: false,
    cellRendererFramework: St002txCheckboxComponent,
  ...
  },
  {
    ...
    filter: false,
    hide: false,
    cellRendererFramework: St002txCheckboxWhtComponent,
  },
  {
    headerName: 'WHT 1%',
    field: 'wht1percent',
...
export { setting, settingLine, defaultCofDef };
