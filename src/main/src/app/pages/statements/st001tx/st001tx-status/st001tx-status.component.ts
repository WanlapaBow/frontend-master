...
@Component({
  selector: 'ngx-st001tx-status',
  templateUrl: './st001tx-status.component.html',
  styleUrls: ['./st001tx-status.component.scss'],
})
export class St001txStatusComponent implements ICellRendererAngularComp {
  public params: any;
  statusList: any = {
    success: {
      title: 'success',
